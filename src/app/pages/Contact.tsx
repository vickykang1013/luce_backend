      ...
      <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div>
                ...
                <p>서울특별시 강남구 테헤란로 123<br />LUCE 빌딩 5층</p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <div>
                ...
                <a
                  ...
                  className="hover:text-[#D4AF37] transition-colors"
                >
                  contact@luce-model.com
                </a>
              </div>
              <div>
                <p className="text-sm text-gray-500 mb-1">영업 시간</p>
                <p>평일 10:00 - 18:00<br />주말 및 공휴일 휴무</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          <div className="flex gap-6">
            <a
              href="https://instagram.com/luce_model"
              target="_blank"
        ...
        <motion.div
          ...
          className="mt-8 bg-white/50 backdrop-blur-sm rounded-lg overflow-hidden shadow-sm"
        >
